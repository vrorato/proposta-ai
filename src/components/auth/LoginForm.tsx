    ...
    return (
        <Card className="w-full max-w-[440px] mx-auto bg-[#0a0a0c] border-white/[0.05] text-white overflow-hidden rounded-[32px] p-2 neon-glow relative">
            ...
            <CardHeader className="pt-12 pb-8 px-10">
                <CardTitle className="text-4xl font-bold tracking-tight mb-3">Welcome Back</CardTitle>
                ...
                <CardContent className="space-y-6 px-10">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <Link href="#" className="text-sm font-semibold text-brand-primary hover:text-brand-primary/80 transition-all">
                                Forgot password?
                            </Link>
                        </div>
                        <div className="relative group">
                    ...
                    <div className="flex items-center space-x-3 ml-1">
                        <Checkbox id="remember" className="rounded-full w-5 h-5 border-white/20 data-[state=checked]:bg-brand-primary data-[state=checked]:text-black" />
                        <label
                            htmlFor="remember"
                            className="text-sm font-medium leading-none text-gray-400 peer-disabled:cursor-not-allowed peer-disabled:opacity-70 cursor-pointer"
                        >
                    ...
                    <Button
                        type="submit"
                        className="w-full bg-[#0df259] hover:bg-[#0df259]/90 text-black font-bold h-14 rounded-2xl shadow-[0_0_20px_rgba(13,242,89,0.2)] transition-all active:scale-[0.98] text-base mt-2"
                        disabled={loading}
                    >
                ...
                <div className="px-10 pb-10 mt-6 space-y-6">
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-[10px] uppercase tracking-[0.2em] font-bold">
                            <span className="bg-[#0a0a0c] px-4 text-gray-600">or continue with</span>
                        </div>
                    </div>
